...
public enum Commands{
	...
	public void onEnable() {
		...
		this.getCommand(Commands.BLOCKOWN.toString()) 
		...
		this.getCommand(Commands.OWN.toString()) 
				.setDescription(Messages.getString("BlockOwn.13"));  //$NON-NLS-1$
		this.getCommand(Commands.UNOWN.toString()).setExecutor(new CE_Unown(this)); 
		...
		this.getCommand(Commands.OWNER.toString()).setExecutor(new CE_Owner(this)); 
		...
		this.getCommand(Commands.PROTECT.toString()).setExecutor(new CE_Protect(this)); 
		this.getCommand(Commands.PROTECT.toString()) 
				.setUsage(ChatColor.RED + Messages.getString("BlockOwn.26"));  //$NON-NLS-1$
		this.getCommand(Commands.PROTECT.toString()) 
				.setDescription(Messages.getString("BlockOwn.28"));  //$NON-NLS-1$
		this.getCommand(Commands.UNPROTECT.toString()).setExecutor(new CE_Unprotect(this)); 
		this.getCommand(Commands.UNPROTECT.toString()) 
				.setUsage(ChatColor.RED + Messages.getString("BlockOwn.31"));  //$NON-NLS-1$
		this.getCommand(Commands.UNPROTECT.toString()) 
				.setDescription(Messages.getString("BlockOwn.33"));  //$NON-NLS-1$
		this.getCommand(Commands.WHITELIST.toString()).setExecutor(new CE_Whitelist(this)); 
		this.getCommand(Commands.WHITELIST.toString()) 
				.setUsage(
						ChatColor.RED
		...
		this.getCommand(Commands.UNWHITELIST.toString()).setExecutor(new CE_Unwhitelist(this)); 
		this.getCommand(Commands.UNWHITELIST.toString()) 
				.setUsage(
						ChatColor.RED
								+ Messages.getString(Messages
		...
		this.getCommand(Commands.PROTECTION.toString()).setExecutor(new CE_Protection(this)); 
		this.getCommand(Commands.PROTECTION.toString()).setUsage( 
				Messages.getString("BlockOwn.17"));  //$NON-NLS-1$
		this.getCommand(Commands.PROTECTION.toString()) 
				.setDescription(Messages.getString("BlockOwn.20"));  //$NON-NLS-1$
		this.getCommand(Commands.MAKE_POOR.toString()).setExecutor(new CE_MakePoor(this)); 
		this.getCommand(Commands.MAKE_POOR.toString()).setUsage(Messages.getString("BlockOwn.3"));  //$NON-NLS-1$
		...
		try {
			if(this.getConfig().getBoolean(Setting.MYSQL_ENABLE.toString())){
				if(this.getConfig().getString(Setting.MYSQL_TYPE.toString()).equalsIgnoreCase("local")){ //$NON-NLS-1$
