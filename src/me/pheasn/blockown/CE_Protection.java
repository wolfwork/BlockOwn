...
public class CE_Protection implements CommandExecutor {
	...
	private void sendLists(Player player , LinkedList<String> blacklist, LinkedList<String> whitelist){
		plugin.say(player, ChatColor.GREEN,Messages.getString("CE_Protection.3")); //$NON-NLS-1$
